...
filename="./csvs/winners-3rd-place-responded-2024-07-10.csv"
...
for ((i=0; i<${#valid_addresses_array[@]}; i+=1)); do
  ...
  echo $t >> ./logs/winners-3rd-place-${teamname}.log
  ...
  sui client ptb \
    ...
    --gas-budget 500000000 >> ./logs/winners-3rd-place-${teamname}.log
